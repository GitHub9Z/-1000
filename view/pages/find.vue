	...
	<view class="content">
		<view class="content-head fixed">
			...
			<view class="content-head-console">
				<view class="content-head-console-sort" @click="handleStatureSortClick">身高{{page_status.stature_sort ? '降序' : '升序'}}<text
					 class="text-gray" :class="page_status.stature_sort ? 'cuIcon-triangledownfill' : 'cuIcon-triangleupfill'"></text></view>
				<view class="content-head-console-age" @click="handleAgeSortClick">年龄{{page_status.age_sort ? '降序' : '升序'}}<text
					 class="text-gray" :class="page_status.stature_sort ? 'cuIcon-triangledownfill' : 'cuIcon-triangleupfill'"></text></view>
